...
fire_df_heat  <- read_csv("data/combined_data/fire_heat_final.csv")
co_data_year  <- read_csv("data/combined_data/co_final.csv")
econ_df_year <- read_csv("data/combined_data/econ_final.csv")
